...
/*------------------------------------------------*/
add_action( 'add_meta_boxes', 'bs_add_gallery_metabox' );
if ( ! function_exists( 'bs_add_gallery_metabox' ) ) {
	function bs_add_gallery_metabox() {
		add_meta_box( 'easy_image_gallery', 'Resimler', 'bs_gallery_metabox', 'products', 'normal', 'high' );
		add_meta_box( 'easy_image_gallery', 'Resimler', 'bs_gallery_metabox', 'albums', 'normal', 'high' );
	}
}
...
/* Check for lightbox
/*------------------------------------------------*/
if ( ! function_exists( 'bs_gallery_has_lightbox' ) ) {
	function bs_gallery_has_lightbox() {
...
/* Load metabox CSS
/*------------------------------------------------*/
add_action( 'admin_head', 'bs_gallery_metabox_css' );
if ( ! function_exists( 'bs_gallery_metabox_css' ) ) {
	function bs_gallery_metabox_css() { ?>
		<style>
...
/*------------------------------------------------*/
add_action( 'admin_print_scripts', 'bs_display_metaboxes', 1000 );
if ( ! function_exists( 'bs_display_metaboxes' ) ) {
	function bs_display_metaboxes() {
	global $metaboxes;
...
function bs_gallery_metabox() {
	...
	if ( ! get_post_meta( get_the_ID(), '_easy_image_gallery_link_images', true ) )
		...
		$checked = bs_gallery_has_lightbox() ? checked( get_post_meta( get_the_ID(), '_easy_image_gallery_link_images', true ), 'on', false ) : ''; ?>
...
/* Save the metabox
/*------------------------------------------------*/
add_action( 'save_post', 'bs_save_gallery_metabox' );
function bs_save_gallery_metabox( $post_id ) {
	if ( defined( 'DOING_AUTOSAVE' ) && DOING_AUTOSAVE )
		return;
	$post_types = array( 'urunler', 'albumler' );
	...
	do_action( 'bs_save_gallery_metabox', $post_id );
}